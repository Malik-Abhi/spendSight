...
const PRODUCTION_API_URL = 'https://spend-sight-ten.vercel.app/api';
...
function resolveApiUrl() {
  ...
  const fallback = __DEV__ ? LOCAL_API_URL : PRODUCTION_API_URL;
  if (Platform.OS === 'web' && isLocalApiUrl(fallback)) {
